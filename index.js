...
function preguntarDatos(actividad) {
    ...
    if (sexo== "mujer" || sexo== "femenino") { 
        ...
        console.log(`Calculadora harris benedict, mujer: ${calculoFemenino(peso,altura,edad,actividad)} `)
        alert (`El total de calorias diarias que debes consumir segun los datos ingresados es de: ${calculoFemenino(peso,altura,edad,actividad)}`)

    }else {

        console.log(`Calculadora harris benedict, hombre: ${calculoMasculino(peso,altura,edad,actividad)} `)
        alert (`El total de calorias diarias que debes consumir segun los datos ingresados es de: ${calculoMasculino(peso,altura,edad,actividad)}`)
